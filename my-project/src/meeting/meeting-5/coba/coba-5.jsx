function Jsx({ nama, pesan }) {
    ...
    return <li className="item">{kalimat}</li>;
  }
      ...
      <>
        <section className="w-1/3 bg-gray-200 px-10 py-20 mt-20 mx-auto rounded-lg shadow-2xl mb-20">
          ...
          <ul className="mt-10 text-[20px] text-center">
            <Jsx pesan={true} nama="Jangan lupa bersyukur" />
            <Jsx pesan={false} nama="Ingatlah Allah" />
            <Jsx pesan={true} nama="Jadilah lebih baik dari hari ini" />
          </ul>
        </section>
      </>
    );
